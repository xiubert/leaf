...
export const DemographicsDefTemplate: PatientListDatasetDefinitionTemplate = {
    columns: new Map([
        ...
        ['patientOf', { datasetId: 'demographics', id: 'patientOf',autoDisplayOnLoad: false, type: PatientListColumnType.String }],
        ['addressPostalCode', { datasetId: 'demographics', id: 'addressPostalCode', autoDisplayOnLoad: false, type: PatientListColumnType.String }],
        ['addressState', { datasetId: 'demographics', id: 'addressState', autoDisplayOnLoad: false, type: PatientListColumnType.String }],
        ...
        ['language', { datasetId: 'demographics', id: 'language', autoDisplayOnLoad: false, type: PatientListColumnType.String }],
        ['maritalStatus', { datasetId: 'demographics', id: 'maritalStatus', autoDisplayOnLoad: false, type: PatientListColumnType.String }],
        ['mrn', { datasetId: 'demographics', id: 'mrn', autoDisplayOnLoad: true, type: PatientListColumnType.String, optional: true }],
        ['name', { datasetId: 'demographics', id: 'name', autoDisplayOnLoad: false, type: PatientListColumnType.String, optional: true }],
        ['race', { datasetId: 'demographics', id: 'race', autoDisplayOnLoad: true, type: PatientListColumnType.String }],
        ['religion', { datasetId: 'demographics', id: 'religion', autoDisplayOnLoad: false, type: PatientListColumnType.String }]
    ]),
    multirow: false,
